function configure_log{
    for f in /etc/nova/nova.conf /etc/glance/glance-api.conf /etc/glance/glance-cache.conf /etc/glance/glance-registry.conf /etc/heat/heat.conf /etc/keystone/keystone.conf /etc/neutron/neutron.conf /etc/tacker/tacker.conf /etc/cinder/cinder.conf
    do
    ...
    iniset /etc/heat/heat.conf log_dir /opt/stack/logs/heat
    ...
    iniset /etc/tacker/tacker.conf log_dir /opt/stack/logs/tacker
